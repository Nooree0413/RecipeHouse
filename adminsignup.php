...
<body>
	...
	<div class="contact-section">
		...
		<div class="contact-inner">
		  <div class="container">
			<h4></h4>
			<form name="myForm" action="process_signupadmin.php" method="post" class="con" onsubmit="regFunc()"> 
				...
				<input type="password" class="text" name="txt_pwd" placeholder="Password" title="Password" required><br/>
				<input type="password" class="text" name="txt_cpwd" placeholder="Confirm Password" title="Confirm Password" required><br/><br/>
				<div>
					
					<input type="checkbox" class="text" name="txt_radio">&nbsp;Newsletters<br/>

          ...
          <?php
           ...
           if(!isset($email)){
            echo"You should login first!!";
                  ...
                  $query=mysql_query("SELECT * FROM adminlogin WHERE admin_email='$email'") or die('cannot find!'.mysql_error());
         ...
         //making responsive table
          ...
          echo"<th>Date Of Birth</th></tr>";
           ...
           while( $row=mysql_fetch_array($query)){
            echo"<tr><td>".$row['admin_email']."</td>";
            echo"<td>".$row['admin_fname']."</td>";
            echo"<td>".$row['admin_lname']."</td>";
            echo"<td>".$row['admin_dob']."</td></tr>";
      }
         echo "</table>";
         echo"</div>";
   }     

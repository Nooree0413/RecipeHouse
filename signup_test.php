		...
		<div class="contact-inner">
		  <div class="container">
			...
			<script type="text/javascript">
					function passCheck(){
						var p = document.forms[0].txt_pwd.value;
						var cp = document.forms[0].txt_cpwd.value;

						if (p != cp)
						{
							document.getElementById('dispmessage').innerHTML = "Passwords do not match";
						}
					}
				</script>
			...
			<form name="myForm" action="" method="post" class="con" onsubmit="passCheck()"> 
			    <input title="First Name" type="text" class="text" value="John" name="txt_fname" placeholder="First Name" title="First Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'First Name';}" required><br/>
				<input type="text" class="text" value="Doe" name="txt_lname" placeholder="Last Name" title="Last Name"onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Last Name';}" required><br/>
				<input type="date" class="text" id="mydateBox" name="txt_dob" value="Date" title="Date Of Birth" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Date';}" required><br/>
				...
				<input type="email" class="text" value="jdoe@yahoo.com" name="txt_email" placeholder="Email Address" title="Email Address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Address';}" required><br/>
				<input type="password" class="text" name="txt_pwd" placeholder="Password" title="Password" onfocus="this.value = '';" required><br/>
				<input type="password" class="text" name="txt_cpwd" placeholder="Confirm Password" title="Confirm Password" onfocus="this.value = '';" required><br/><br/>
				<div>
			...
			<script>
					...
					function regFunc() {
						...
						{
							alert("Please check if both passwords match!");
						}
					}
				</script>

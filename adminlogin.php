...
<body>
	...
	<div class="contact-section">
		...
		<div class="contact-inner">
		  <div class="container">
			<h4></h4>
			<form name="myForm" action="process_adminlogin.php" method="post" class="con" onsubmit="regFunc()"> 
				...
				<input type="password" class="text" name="txt_pwd" placeholder="Password" title="Password" required><br/>
					...
					<span style="font-size:90%;">Not registered? <a href="signup.php" style="color:#1BBC9B;margin:5px 0 0 0">Create an account</a></span></span><br/>
